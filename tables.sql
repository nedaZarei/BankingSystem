...
COMMENT ON COLUMN account.close_date IS 'can be null';
...
CONSTRAINT manages_employee_id_foreign FOREIGN KEY (employee_id) REFERENCES employee (employee_id),
CONSTRAINT manages_account_id_foreign FOREIGN KEY (account_id) REFERENCES account (account_id)
);
...
CONSTRAINT transaction_source_account_id_foreign FOREIGN KEY (source_account_id) REFERENCES account (account_id),
CONSTRAINT transaction_destination_account_id_foreign FOREIGN KEY (destination_account_id) REFERENCES account (account_id)
);
...
PRIMARY KEY (loan_id),
CONSTRAINT loan_customer_id_foreign FOREIGN KEY (customer_id) REFERENCES customer (customer_id)
);
